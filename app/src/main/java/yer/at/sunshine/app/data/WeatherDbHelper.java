...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_LOCATIONENTRY_TABLE = "CREATE TABLE " +
        ...
        Log.d(LOG_TAG, "onCreate() execSQL: " + SQL_CREATE_LOCATIONENTRY_TABLE);
        sqLiteDatabase.execSQL(SQL_CREATE_LOCATIONENTRY_TABLE);
    }
