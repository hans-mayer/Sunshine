package yer.at.sunshine.app.service;
...
public class SunshineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String units = "metric";
        int numDays = 14;
        String API_key = "6e4692564a3549b53ea8aab3bf7ed394";
        ...
        try {
            ...
            Log.d(LOG_TAG, "onHandleIntent() " + builtUri.toString());
            ...
            Log.e(LOG_TAG, "Error 115 : " + e115.toString());
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Log.d(LOG_TAG, "addLocation: " + locationSetting + " " + cityName);
